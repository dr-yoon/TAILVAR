...
Pop_AF <-c("UK10K_AF", "ESP6500_AA_AF", "ESP6500_EA_AF", "gnomAD_exomes_AF", "gnomAD_exomes_POPMAX_AF", "gnomAD_genomes_AF", "gnomAD_genomes_POPMAX_AF", "ALFA_Total_AF")
comp_scores <- c("CADD_phred", "DANN_score", "MutationTaster_score", "fathmm-MKL_coding_score", "Eigen-phred_coding", "BayesDel_addAF_score", "BayesDel_noAF_score", "integrated_fitCons_score", "GERP++_RS", "phyloP100way_vertebrate", "phastCons100way_vertebrate")

dataset <- dataset %>% 
  mutate(MutationTaster_score = sub(",.*", "", MutationTaster_score)) %>%
...
comp_scores_rename <- c("CADD", "DANN", "MutationTaster", "FATHMM", "EIGEN", "BayesDel_addAF", "BayesDel_noAF", "int_fitCons", "GERP", "phyloP100way", "phastCons100way")
